...
<body>
    <div class="container">
        ...
        <footer class="footer">
            ...
            <p><a href="detailed_report.html">View Detailed Report</a></p>
        </footer>
    </div>
</body>
</html>"""
...
<head>
    ...
    <style>
        ...
        .scan-item {{ margin: 15px 0; padding: 15px; background: #f9f9f9; border-radius: 5px; }}
        .scan-link {{ text-decoration: none; color: #007acc; font-weight: bold; }}
        .scan-link:hover {{ color: #005a9e; }}
    </style>
</head>
<body>
    <div class="container">
        ...
        <ul class="scan-list">
        {''.join(f'<li class="scan-item"><a href="{scan_dir.name}/index.html" class="scan-link">📊 {scan_dir.name}</a></li>' for scan_dir in scan_dirs)}
        </ul>
    </div>
</body>
</html>"""
